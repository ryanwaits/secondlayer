...
function printHelp() {
	console.log(`Usage:
  bun run packages/indexer/src/datasets/stx-transfers/export.ts --latest-finalized [--upload] [--force]
  bun run packages/indexer/src/datasets/stx-transfers/export.ts --from-block 180000 --to-block 189999 [--upload] [--force]
