...
export const OPENAPI_SPEC = {
	...
	paths: {
		...
		// Deprecated /api/subscriptions aliases — removed in plan 015.
		"/api/subscriptions": {
			get: {
				tags: ["webhooks"],
				deprecated: true,
				summary: "Deprecated alias of /api/webhooks",
				security: WRITE_SECURITY,
				parameters: [
					qp("_limit", "integer", false, "Page size, 1–200 (default 50)."),
					qp("_offset", "integer"),
		...
		"/api/subscriptions/{id}": {
			get: {
				tags: ["webhooks"],
				deprecated: true,
				summary: "Deprecated alias of /api/webhooks/{id}",
				security: WRITE_SECURITY,
				parameters: [pp("id")],
				responses: apiReadResponses({ "404": jsonError() }),
			},
		...
		"/api/subscriptions/{id}/pause": {
			post: {
				tags: ["webhooks"],
				deprecated: true,
				summary: "Deprecated alias of /api/webhooks/{id}/pause",
				security: WRITE_SECURITY,
				parameters: [pp("id")],
				responses: writeResponses({ "404": jsonError() }),
			},
		...
		"/api/subscriptions/{id}/resume": {
			post: {
				tags: ["webhooks"],
				deprecated: true,
				summary: "Deprecated alias of /api/webhooks/{id}/resume",
				security: WRITE_SECURITY,
				parameters: [pp("id")],
				responses: writeResponses({ "404": jsonError() }),
			},
		...
		"/api/subscriptions/{id}/rotate-secret": {
			post: {
				tags: ["webhooks"],
				deprecated: true,
				summary: "Deprecated alias of /api/webhooks/{id}/rotate-secret",
				description:
					"Returns the new secret once. Deliveries signed with the old secret stop verifying immediately.",
				security: WRITE_SECURITY,
				parameters: [pp("id")],
		...
		"/api/subscriptions/{id}/test": {
			post: {
				tags: ["webhooks"],
				deprecated: true,
				summary: "Deprecated alias of /api/webhooks/{id}/test",
				description:
					"Builds a sample event in the webhook's format, posts it to the configured URL through the SSRF guard, and records it under deliveries.",
				security: WRITE_SECURITY,
				parameters: [pp("id")],
		...
		"/api/subscriptions/{id}/deliveries": {
			get: {
				tags: ["webhooks"],
				deprecated: true,
				summary: "Deprecated alias of /api/webhooks/{id}/deliveries",
				security: WRITE_SECURITY,
				parameters: [pp("id")],
				responses: apiReadResponses({ "404": jsonError() }),
			},
		...
		"/api/subscriptions/{id}/dead": {
			get: {
				tags: ["webhooks"],
				deprecated: true,
				summary: "Deprecated alias of /api/webhooks/{id}/dead",
				security: WRITE_SECURITY,
				parameters: [pp("id")],
				responses: apiReadResponses({ "404": jsonError() }),
			},
		...
		"/api/subscriptions/{id}/dead/{outbox_id}/requeue": {
			post: {
				...
				deprecated: true,
				summary:
					"Deprecated alias of /api/webhooks/{id}/dead/{outbox_id}/requeue",
				security: WRITE_SECURITY,
				parameters: [pp("id"), pp("outbox_id")],
				responses: writeResponses({ "404": jsonError() }),
			},
		...
		"/api/subscriptions/{id}/replay": {
			post: {
				tags: ["webhooks"],
				deprecated: true,
				summary: "Deprecated alias of /api/webhooks/{id}/replay",
				description:
					"Queues historical events for redelivery; replays drain through a 10% share of the outbox so live traffic keeps priority. 202 on accept.",
				security: WRITE_SECURITY,
				parameters: [pp("id")],
