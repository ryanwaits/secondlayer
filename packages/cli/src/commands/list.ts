...
import { handleApiError, listStreams } from "../lib/api-client.ts";
import { dim, formatTable, green, red, yellow } from "../lib/output.ts";
...
export function registerListCommand(program: Command): void {
	program
		...
		.option(
			"-s, --status <status>",
			"Filter by status (inactive/active/paused/failed)",
		)
