import { MAX_I128, MAX_U128, MIN_I128 } from "../../utils/constants.ts";
...
export type AbiList<T extends AbiType = AbiType, L extends number = number> = {
	list: { type: T; length: L };
};

export type AbiTuple<T extends ReadonlyArray<{ name: string; type: AbiType }>> =
	{
		tuple: T;
	};
