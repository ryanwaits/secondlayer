...
export type ExtractMapNames<C extends AbiContract> =
	C["maps"] extends ReadonlyArray<{ name: infer N extends string }> ? N : never;

export type ExtractMap<
	C extends AbiContract,
	N extends ExtractMapNames<C>,
> = C["maps"] extends ReadonlyArray<infer M> ? Extract<M, { name: N }> : never;
...
export type ExtractConstants<C extends AbiContract> = ExtractVariableNames<
	C,
	"constant"
>;

export type ExtractDataVars<C extends AbiContract> = ExtractVariableNames<
	C,
	"variable"
>;
