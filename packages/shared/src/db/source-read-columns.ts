...
// read mirror is fully typed and can't drift from the API. The drift test
...
export const SOURCE_READ_TYPES = {
	...
	pox5_events: {
		amount_sats: { type: "text", nullable: true },
		amount_ustx: { type: "text", nullable: true },
		block_height: { type: "int" },
		block_time: { type: "timestamp" },
		bond_index: { type: "int", nullable: true },
		canonical: { type: "boolean" },
		cursor: { type: "text" },
		data: { type: "jsonb", nullable: true },
		event_index: { type: "int" },
		first_reward_cycle: { type: "int", nullable: true },
		is_l1_lock: { type: "boolean", nullable: true },
		reward_cycle: { type: "int", nullable: true },
		signer: { type: "text", nullable: true },
		signer_key: { type: "text", nullable: true },
		signer_manager: { type: "text", nullable: true },
		staker: { type: "text", nullable: true },
		topic: { type: "text" },
		tx_id: { type: "text" },
		tx_index: { type: "int" },
		unlock_burn_height: { type: "int", nullable: true },
		unlock_cycle: { type: "int", nullable: true },
	},
	sbtc_events: {
		amount: { type: "text", nullable: true },
