...
function generateKysely(
	...
	return [
		"// Generated by `sl codegen index --target kysely`. Do not edit by hand.",
...
function generateDrizzle(
	...
	return [
		"// Generated by `sl codegen index --target drizzle`. Do not edit by hand.",
...
function generatePrisma(
	...
	const header = [
		"// Generated by `sl codegen index --target prisma`. Do not edit by hand.",
		...(skipped.length
			? [
