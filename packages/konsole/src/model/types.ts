...
export interface Model {
  ...
  where(columnOrConditions: string | Row, value?: unknown): import("./query-chain.ts").QueryChain;
  ...
  order(column: string, direction?: "asc" | "desc"): import("./query-chain.ts").QueryChain;
