...
APP_SERVICES="api indexer decoder subgraph-processor webhook-processor worker console caddy"
...
# recreates in bulk.
APP_SERVICES_NO_API="indexer decoder subgraph-processor webhook-processor worker console caddy"
...
_pull_services=(api indexer decoder subgraph-processor webhook-processor worker migrate)
