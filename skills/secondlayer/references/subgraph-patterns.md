# Subgraph Handler Patterns

Complete `defineSubgraph()` examples for common use cases.
  ...
  schema: {
    listings: {
      columns: {
        ...
        price:    { type: "uint" },
        status:   { type: "text" },  // active, sold, cancelled
      },
      uniqueKeys: [["nft_id"]],
    },
    sales: {
...
## Token Transfers with Running Balances
