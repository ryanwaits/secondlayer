...
export function Notation({
  ...
  }, [shown, type, color, strokeWidth, padding, animate, animationDuration, iterations, brackets, multiline]);
...
export function NotationBlock({
  ...
  useEffect(() => {
    ...
    observer.observe(ref.current);
    return () => observer.disconnect();
  }, [shown, type, color, strokeWidth, padding, animate, animationDuration, iterations, brackets]);
