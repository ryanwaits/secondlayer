...
const NO_INSTANCE_RESULT = {
	...
	missing: "instance",
	message:
		"No Secondlayer instance exists for this account yet. Create one from the Instance page or run `sl instance create --plan hobby` before deploying or querying subgraphs.",
	nextActions: [
