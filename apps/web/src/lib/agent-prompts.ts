...
const VIEWS_INTRO = `Views are like subgraphs — define SQL tables, write event handlers in TypeScript, and secondlayer indexes matching blockchain activity into queryable Postgres tables. Think materialized views over the chain.`;
...
export const VIEWS_EMPTY_PROMPT = `${VIEWS_INTRO}

${SETUP}

/secondlayer Help me create a view. Ask me:
1. What contract do I want to index?
2. Which events or function calls should I track?
3. What columns do I need in my tables?

Scaffold the view, let me review it, then deploy.`;
...
export const QUICK_VIEW_PROMPT = `${VIEWS_INTRO}

${SETUP}

/secondlayer Scaffold a view that indexes swap events from the ALEX DEX contract SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.amm-pool-v2-01 and deploy it.`;
...
export const DROPDOWN_DEPLOY_VIEW = `${VIEWS_INTRO}

${SETUP}

/secondlayer Scaffold and deploy a new view. Ask me what contract and events to index.`;
...
1. Do I want to create a stream (webhook delivery) or a view (custom indexer)?
...
export const DASHBOARD_VIEWS_PROMPT = `${VIEWS_INTRO}
...
export const MARKETING_VIEWS_PROMPT = VIEWS_EMPTY_PROMPT;
