			...
			<div style={{ flex: 1, overflowY: "auto" }}>
				<div className="empty-inner" style={{ padding: "40px 0 0" }}>
					...
					<p className="empty-desc">
						...
						events, run on a schedule, or fire on demand. Create one from your
						terminal or SDK.
					</p>
						...
						<div className="empty-card">
							...
							<div className="empty-card-body">
								...
								<div className="empty-card-desc">
									Run <code style={{ fontSize: 12, background: "var(--code-bg)", padding: "1px 5px", borderRadius: 3 }}>sl workflows deploy workflows/my-workflow.ts</code> to
									deploy a workflow from your terminal.
								</div>
							</div>
						</div>
						<div className="empty-card">
							...
							<div className="empty-card-body">
								...
								<div className="empty-card-desc">
									Define workflows with <code style={{ fontSize: 12, background: "var(--code-bg)", padding: "1px 5px", borderRadius: 3 }}>@secondlayer/workflows</code>.
