...
const CHART_HEIGHTS = [
	35, 42, 38, 50, 45, 55, 60, 48, 52, 58, 42, 65, 70, 62, 55, 48, 72, 78, 68,
	80, 75, 82, 88, 85, 90, 78, 92, 95, 88, 100,
];
			...
			<OverviewTopbar
				path={
					<>
						...
						{" / "}
						<Link
							href={`/marketplace/creator/${sg.creatorHandle}`}
					...
					<div className="mp-sg-header">
						<div className="mp-sg-header-left">
							<div className="mp-sg-name">
								{sg.name}{" "}
								<span className={`badge ${sg.status}`}>{sg.status}</span>
							</div>
							<p className="mp-sg-desc">{sg.description}</p>
							<div className="mp-sg-creator">
								by{" "}
								<Link href={`/marketplace/creator/${sg.creatorHandle}`}>
									@{sg.creatorHandle}
								</Link>
							</div>
					...
					<div className="mp-stats-row">
						<div className="sg-meta-card">
							...
							<div
								...
								style={{ fontSize: 20, fontFamily: "var(--font-mono-stack)" }}
							>
								12,438
							</div>
							<div
								style={{ fontSize: 11, color: "var(--green)", marginTop: 2 }}
							>
								+18% vs prev week
							</div>
						</div>
							...
							<div className="mp-table-card">
								<div className="mp-table-header">
									...
									<div className="mp-table-meta">
										<span>482,319 rows</span>
										<span>6 columns</span>
									</div>
								</div>
								<div className="mp-table-columns">
									<div className="mp-table-col">
										<span className="mp-col-name">tx_id</span>{" "}
										<span className="mp-col-type">text</span>
									</div>
									<div className="mp-table-col">
										<span className="mp-col-name">block_height</span>{" "}
										<span className="mp-col-type">integer</span>
									</div>
									<div className="mp-table-col">
										<span className="mp-col-name">sender</span>{" "}
										<span className="mp-col-type">text</span>
									</div>
									<div className="mp-table-col">
										<span className="mp-col-name">token_in</span>{" "}
										<span className="mp-col-type">text</span>
									</div>
								</div>
								<div className="mp-table-endpoint">
									Endpoint{" "}
									<span className="mp-endpoint-url">
										/api/marketplace/subgraphs/{sg.slug}/swaps
									</span>
								</div>
							</div>
						</div>
					...
					<DetailSection title="Details">
						<div className="mp-meta-grid">
							<div className="mp-meta-item">
								<span className="mp-meta-label">Start Block</span>
								<span className="mp-meta-value">100,000</span>
							</div>
							<div className="mp-meta-item">
								<span className="mp-meta-label">Last Processed Block</span>
								<span className="mp-meta-value">7,482,103</span>
							</div>
							<div className="mp-meta-item">
								<span className="mp-meta-label">Created</span>
								<span className="mp-meta-value">2025-11-14</span>
							</div>
							<div className="mp-meta-item">
								<span className="mp-meta-label">Last Updated</span>
								<span className="mp-meta-value">2026-04-01</span>
							</div>
						</div>
					</DetailSection>
				</div>
