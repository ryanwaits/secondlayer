...
export default function SettingsPage() {
	...
	const handleSave = useCallback(async () => {
		...
		try {
			await updateProject.mutateAsync({
				slug: project.slug,
				data: { name, nodeRpc: nodeRpc || null },
			});
			setSaveStatus("saved");
	...
	const handleDelete = useCallback(async () => {
		...
		if (
			!confirm(
				"Delete this project? This will remove all subgraphs and data. This cannot be undone.",
			)
		)
			return;
		try {
			...
			<div className="settings-scroll">
				<div className="settings-inner">
					...
					<p className="settings-desc">
						Manage your project configuration, network, and display preferences.
					</p>
							...
							<div className="settings-field">
								<label className="settings-label">
									...
									<input
										...
										className="settings-input mono"
										value={nodeRpc}
										onChange={(e) => setNodeRpc(e.target.value)}
						...
						{account && (
							...
							>
								<div>
									...
									>
										{account.plan} &middot; Member since{" "}
