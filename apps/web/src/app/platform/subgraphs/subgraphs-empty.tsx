...
export function SubgraphsEmpty() {
  return (
    <>
      <p className="dash-empty">No subgraphs yet. Get set up and deploy your first subgraph.</p>
      ...
      <QuickStartSection>
        <QuickStartCard
          icon={<svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="2" y="2" width="12" height="12" rx="2"/><path d="M5 6h6M5 8h4M5 10h5"/></svg>}
