 ...
 * should be answerable without leaving the page or handing a prompt to an
 * agent first.
 */
...
function isFailure(d: Delivery): boolean {
 ...
 */
export function summarizeDeliveries(rows: Delivery[]): DeliveryStats {
