  ...
  { type: "print_event", contractId: "SP1234...::token", topic: "transfer" },
        ...
        <div className="props-section" style={{ marginTop: "var(--spacing-xs)" }}>
          ...
          <div className="prop-row">
            ...
            <span className="prop-type">sender, recipient, minAmount, maxAmount</span>
          </div>
          <div className="prop-row">
          ...
          <div className="prop-row">
            ...
            <span className="prop-type">sender, recipient, assetIdentifier, minAmount</span>
          </div>
          <div className="prop-row">
            <span className="prop-name">ft_mint</span>
            <span className="prop-type">recipient, assetIdentifier, minAmount</span>
          </div>
          <div className="prop-row">
            <span className="prop-name">ft_burn</span>
            <span className="prop-type">sender, assetIdentifier, minAmount</span>
          </div>
          <div className="prop-row">
            <span className="prop-name">nft_transfer</span>
            <span className="prop-type">sender, recipient, assetIdentifier, tokenId</span>
          </div>
          <div className="prop-row">
            <span className="prop-name">nft_mint</span>
            <span className="prop-type">recipient, assetIdentifier, tokenId</span>
          </div>
          <div className="prop-row">
...
await client.streams.replayFailed("a1b2c3")`} />
        ...
        <div className="prose">
          <p>
            Manage streams from the command line. The CLI generates config
            files and registers them with the API.
          </p>
        </div>

        <CodeBlock code={`# Generate a new stream config
...
sl streams rotate-secret a1b2c3`} />
        ...
        <div className="props-section">
          ...
          <div className="prop-row">
            ...
            <span className="prop-type">&apos;inactive&apos; | &apos;active&apos; | &apos;paused&apos; | &apos;failed&apos;</span>
          </div>
          <div className="prop-row">
