...
It isn't stuck, and the distinction between those two places is the single most useful thing to understand about how checkpointed consumers work.
...
The gap between cursor and tip contains, provably per the index, nothing addressed to this consumer. Re-asking is free. Everything else follows from that.
