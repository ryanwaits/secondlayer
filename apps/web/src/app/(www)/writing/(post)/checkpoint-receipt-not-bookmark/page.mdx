...
When the answer is "no rows," the consumer has not skipped forty thousand blocks of work. There was never forty thousand blocks of work. There was one question, and the answer was no. And because a seek costs the same at any cursor age, restarting "from" 8,637,064 costs exactly what polling from the tip would cost:
