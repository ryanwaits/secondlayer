    ...
    trigger.ftTransfer({ trait: "sip-010", minAmount: "1000000" }),
				...
				<div className="prose">
					<p>
						...
						, and the <code>stx*</code>/<code>ft*</code>/<code>nft*</code>{" "}
						transfer, mint, and burn variants. Each takes filter fields (
						...
						<code>trait</code> scopes a trigger to a whole SIP. The raw object
						form (
				...
				<div className="prose">
					...
					<p>
						Chain subscriptions deliver a <code>chain.{"{type}"}.apply</code>{" "}
						envelope (<code>block_hash</code>, <code>block_height</code>,{" "}
						...
						at-least-once, so key your state on <code>(tx_id, block_hash)</code>
						.
					</p>
				</div>
...
webhook-id:        <uuid>          # stable across retries — key dedup on this
