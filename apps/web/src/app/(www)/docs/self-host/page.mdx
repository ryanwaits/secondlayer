...
Support is **community/best-effort** — file issues at [github.com/ryanwaits/secondlayer](https://github.com/ryanwaits/secondlayer). For managed hosting with SLAs and priority support, see [pricing](/pricing).
