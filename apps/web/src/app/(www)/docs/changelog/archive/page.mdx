...
Releases before July 2026, kept as history of the withdrawn hosted service; keys, tiers, and hosted URLs below no longer apply. Current releases: [Changelog](/docs/changelog).
...
export const metadata = {
	title: "Changelog archive — Secondlayer Docs",
	description: "Secondlayer platform and SDK releases before July 2026.",
};
