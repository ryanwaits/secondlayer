...
Reading bond prints from your instance is on [PoX-5 events](/docs/pox5-events). This page is the wallet and proof side, from `@secondlayer/stacks`.

<Banner label="SIP-045 / Epoch 4.0" title="Wallet actions gate on chain-reported activation.">

`client.pox5.isActive()` reads `/v2/pox`, not a hardcoded height. Epoch 4.0 activated at Bitcoin block **960,230**.
