...
A leaked scoped key can't escalate: it reads only its surface and can't mint. Keep keys server-side. Rotate or revoke them anytime in the [platform console](https://app.secondlayer.tools/platform/api-keys).

## Creating a key

Create a key in the [platform console](https://app.secondlayer.tools/platform/api-keys); console keys default to `account`.
