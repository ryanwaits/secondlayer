...
```bash
secondlayer subgraphs deploy ./subgraph.config.ts --visibility private
secondlayer subgraphs publish sbtc-flows     # make public
secondlayer subgraphs unpublish sbtc-flows   # make private again
```
