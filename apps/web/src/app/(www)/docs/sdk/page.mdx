...
Both are canonical in [Subscriptions](/docs/subscriptions/deliveries#verify-the-signature).
...
- **`fromHeight: 0`** backfills as far back as your instance holds. Official-archive restore is [metered](/docs/authentication#archive-credits).
...
See [Sinks](/docs/sinks), [Index, Build your index on it](/docs/index#build-your-index-on-it).
