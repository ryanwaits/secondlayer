...
Per-endpoint parameters and response codes: [API reference](/docs/api-reference). Optional `/extended` JSON on :3999 is a different shape: [Extended view](/docs/extended).
