...
If you're here because hosted Chainhook devnet support left you stuck, this is the replacement: a local indexer that runs your subgraphs and fires [subscriptions](/docs/subscriptions) against devnet blocks. See [Migrating from Chainhook](/docs/migrate-chainhook) for the predicate-to-trigger mapping.
