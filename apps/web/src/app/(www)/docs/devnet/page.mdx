...
```bash
SECONDLAYER_API_URL=http://localhost:3800 \
...
export const metadata = {
	...
	description:
		"Run the full Secondlayer stack against your local Clarinet devnet: deploy contracts and watch subgraphs index them, no cloud, no accounts, no key to read your data.",
};
