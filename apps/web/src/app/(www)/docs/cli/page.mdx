...
Named aliases per function (`TokenTransferArgs`) plus a `TypedAbi` const. Feed it to `getContract` from [`@secondlayer/stacks`](/docs/stacks#also-in-the-box); Clarinet tests use the [simnet transport](/docs/stacks#test-against-clarinet-simnet).
