...
Run the full pipeline against a local [Clarinet](https://docs.hiro.so/stacks/clarinet) devnet — write Clarity, `clarinet devnet start`, and index it locally with subgraphs and subscriptions.
