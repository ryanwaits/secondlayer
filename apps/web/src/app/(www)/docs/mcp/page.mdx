...
| --- | --- | --- |
| Index | Anonymous or any key; see [Authentication](/docs/authentication) | — |
...
export const metadata = {
	...
	description:
		"The Secondlayer MCP server: stdio and HTTP transports, resources, and 33 tools for Index, Subgraphs, Streams, Subscriptions, contracts, and account.",
};
