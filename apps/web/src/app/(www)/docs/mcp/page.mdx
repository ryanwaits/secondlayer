...
| --- | --- | --- |
| Index | Anonymous (free-tier keys rejected; Build+ for keyed access) | — |
...
Thirty-two tools across seven domains. Reads are cursor-paginated; writes that kick off work (reindex, backfill, replay, deploy) return an `operationId` you can poll.
