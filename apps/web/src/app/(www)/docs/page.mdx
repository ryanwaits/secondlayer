...
[Archive](/docs/archive) is the signed history your instance bootstraps from.
[Streams](/docs/streams) hands you raw signed events.
[Index](/docs/index) decodes them into rows you query.
[Subgraphs](/docs/subgraphs) fills a table you define.
[Webhooks](/docs/webhooks) posts to a URL you run.
