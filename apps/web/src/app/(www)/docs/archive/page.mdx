...
Bootstrap, backfill, and reindex fetch from the archive metered per unit; verification is free. Buy with `secondlayer credits buy`; packs and balance: [archive credits](/docs/authentication#archive-credits).
