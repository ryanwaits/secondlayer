...
const ORM_CODE = `// Generated by: sl index codegen --target kysely
import { Kysely } from "kysely";
import type { IndexDB } from "./index-db.gen";

const db = new Kysely<IndexDB>({ dialect });

// Fully typed query over the decoded mirror —
// columns and filters are inferred from the schema.
const sales = await db
  .selectFrom("ft_events")
  .select(["sender", "recipient", "amount", "block_height"])
					...
					<div className="pp-stage-inner">
						<CodeTabs
							tabs={[
								...
								{
									label: "index-db.ts",
									content: <CodeBlock code={ORM_CODE} lang="typescript" />,
								},
							]}
						/>
					</div>
