...
interface DataPayloadPopoverProps {
	/** Full row rendered as flat JSON in the popover. */
	row: Record<string, unknown>;
}

/**
 * "Data" button that opens an anchored popover with the full row as flat JSON.
 * Portaled to `document.body` because the data table clips overflow;
 * positioned with fixed coordinates from the trigger's rect and re-anchored on
 * scroll/resize. Closes on Esc or outside click.
 *
 * The hosted console Shiki-highlighted this JSON; the self-hosted console
 * renders the plain fallback instead of shipping a highlighter bundle.
 */
